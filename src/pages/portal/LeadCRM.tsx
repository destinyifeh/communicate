...
import {
  ...
  StatusUpdateMenu,
  TicketStatus,
} from "@/components/portal/StatusUpdateMenu";
...
export default function LeadCRM() {
  ...
  const [leads, setLeads] = useState<LeadItem[]>(
    mockLeads.map((l) => ({ ...l, status: l.status as LeadStatus })),
  );
  ...
  const getTabs = () => {
    if (businessKind === "vendor") {
      ...
      return [{ id: "leads", label: "Leads", icon: UserPlus }];
    }
  };
    ...
    <ClientLayout>
      <div className="space-y-4 md:space-y-6 min-w-0 max-w-full overflow-hidden">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          {/* Leads Tab */}
          <TabsContent value="leads" className="space-y-4 min-w-0">
            <Card className="border-border/50 overflow-hidden max-w-full">
              <CardContent className="p-3 md:p-4">
                <div className="flex flex-col gap-3 md:gap-4">
                  ...
                  <div className="flex flex-wrap gap-1.5 md:gap-2">
                    ...
                    <Button
                      variant={
                        statusFilter === "interested" ? "default" : "outline"
                      }
                      size="sm"
                        ...
                        >
                          ...
                          <TableCell>
                            <Badge
                              ...
                              className={cn(
                                "whitespace-nowrap",
                                platformIcons[lead.platform].color,
                              )}
                            >
